    ...
    static properties_list(model) {
        switch (model) {
            ...
            case "viomi.aircondition.y116":
                return {
                    'air-conditioner:on': "Power",
                    'air-conditioner:mode': "Current_Mode",
                    'air-conditioner:fault': "Fault_State",
                    'air-conditioner:target-temperature': "Target_Temp",
                    'air-conditioner:eco': "Current_Eco",
                    'air-conditioner:sleep-mode': "Sleep_Mode",
                    'fan-control:fan-level': "Fan_Speed",
                    'fan-control:horizontal-swing': "Hor_Swing",
                    'fan-control:vertical-swing': "Vert_Swing",
                    'environment:temperature': "Current_Temp",
                    'indicator-light:on': "Light_State",
                    'function:uv': "Uv_Mode",
                    'function:auto-clean': "Auto_Clean",
                    'function:autoclean-worktime': "Auto_Clean_Work"
                };
